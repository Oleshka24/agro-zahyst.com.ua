...
class BuyCore {
    ...
    public function styleAddFrontPage() {
        ...
        if (file_exists($wp_uploads_dir['basedir'] . '/' . self::PATCH_PLUGIN . '/css/general.css')) {
            wp_register_style('buyonclickfront-general', $wp_uploads_dir['baseurl'] . '/' . self::PATCH_PLUGIN . '/css/general.css');
        } elseif (file_exists(get_stylesheet_directory() . '/' . self::PATCH_PLUGIN . '/css/general.css')) {
            wp_register_style('buyonclickfront-general', get_stylesheet_directory_uri() . '/' . self::PATCH_PLUGIN . '/css/general.css');
        } else {
