...
class RestController
{
    ...
    public function __construct( FileManager $fileManager )
    {
        ...
        add_action( 'wp_enqueue_scripts', function () use( $fileManager ) {
            wp_enqueue_script( 'premmerce_search', $fileManager->locateAsset( 'frontend/js/autocomplete.js' ), [ 'jquery', 'jquery-ui-autocomplete' ] );
            $localize_array = apply_filters( 'premmerce_search_localize_array', [
