...
* Расчет стоимости доставки в зависимости от суммы заказа.
* Автоматический расчет стоимости доставки используя API Новой Почты.
* Полноценная работа адресной доставки (используя онлайн-справочник улиц Новой Почты).
* Возможность включить отдельный расчет стоимости для адресной доставки.
* Простой и быстрый функционал создания Экспресс-накладных всех типов.
* Вывод экспресс-накладных на печать всех типов.
* Оповещение ваших клиентов о сформированных для них экспресс-накладных по email.
* Интеграция оповещений ваших пользователей по СМС (используя доп. расширение).
