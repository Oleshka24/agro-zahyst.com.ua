...
$fndFormSearch = carbon_get_theme_option('fnd-form-search');
?>
    ...
    <section class="products">
        <div class="container">
            <div class="content title">
                <?php if (have_posts()) : ?>
                    <h1><? pll_e('Результаты поиска'); ?>: <span
                                class="search-word"> <? print get_search_query() ?> </span></h1>
                <?php else : ?>
                    <h1><? pll_e('По Вашему запросу ничего не найдено'); ?></h1>
                    <h3><? pll_e('Поискать ещё'); ?></h3>
