<div class="police">
    <div class="sitetext">
    <center><h2>ПУБЛІЧНА ОФЕРТА (ПУБЛІЧНИЙ ДОГОВІР)</h2></center>
        ...
        <p>1.3. Інтернет-магазин – сайт Продавця за адресою www.agro-zahyst.com.ua створений для укладення договорів роздрібної та оптової купівлі-продажу на підставі ознайомлення Покупця із запропонованим Продавцем описом Товару за допомогою мережі Інтернет.</p>
        ...
        <p>1.5. Продавець – Товариство з обмеженою відповідальністю «Торговий Дім «Агрозахист» (ідентифікаційний код 43869065), юридична особа, яка створена і діє відповідно до чинного законодавства України, місцезнаходження якої: Україна, 49051, Дніпропетровська обл., м. Дніпро, пр. Слобожанський, буд. 40-А</p>
        ...
        <h2>Реквізити</h2>
        <p>Товариство з обмеженою відповідальністю «Торговий Дім «Агрозахист» (ідентифікаційний код 43869065), юридична особа, яка створена і діє відповідно до чинного законодавства України, місцезнаходження якої: Україна, 49051, Дніпропетровська обл., м. Дніпро, пр. Слобожанський, буд. 40-А</p>
        <p>&nbsp;</p>
        <p><i><strong>Оновлено 25.10.2020 р.</strong></i></p>
    </div>
</div>